...
import GifViewer.load.data.DataRewinder;
import GifViewer.load.data.DataRewinderRegistry;
import GifViewer.load.engine.DecodePath;
import GifViewer.load.engine.LoadPath;
...
import GifViewer.load.model.ModelLoaderRegistry;
import GifViewer.load.resource.transcode.ResourceTranscoder;
import GifViewer.load.resource.transcode.TranscoderRegistry;
import GifViewer.provider.EncoderRegistry;
import GifViewer.provider.LoadPathCache;
import GifViewer.provider.ModelToResourceClassCache;
import GifViewer.provider.ResourceDecoderRegistry;
import GifViewer.provider.ResourceEncoderRegistry;
import GifViewer.util.pool.FactoryPools;
...
public class Registry {
  ...
  /**
   * Use the given factory to build a {@link GifViewer.load.model.ModelLoader} for models
  ...
  /**
   * Thrown when no {@link GifViewer.load.model.ModelLoader} is registered for a given
   * model class.
   */
