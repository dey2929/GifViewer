...
import GifViewer.load.resource.bitmap.BitmapDrawableTransformation;
import GifViewer.load.resource.bitmap.BitmapEncoder;
import GifViewer.load.resource.bitmap.CenterCrop;
import GifViewer.load.resource.bitmap.CenterInside;
import GifViewer.load.resource.bitmap.CircleCrop;
import GifViewer.load.resource.bitmap.DownsampleStrategy;
...
public abstract class BaseRequestOptions<CHILD extends BaseRequestOptions<CHILD>>
  ...
  /**
   * Applies a multiplier to the {@link GifViewer.request.target.Target}'s size before
   ...
   *                       {@link GifViewer.request.target.Target}'s dimensions when
  ...
  /**
   * Sets the {@link GifViewer.load.engine.DiskCacheStrategy} to use for this load.
   *
   * <p> Defaults to {@link GifViewer.load.engine.DiskCacheStrategy#AUTOMATIC}. </p>
   *
   * <p> For most applications {@link GifViewer.load.engine.DiskCacheStrategy#RESOURCE} is
   ...
   * using {@link GifViewer.load.engine.DiskCacheStrategy#DATA} or
   * {@link GifViewer.load.engine.DiskCacheStrategy#ALL}. </p>
   *
   ...
   * {@link GifViewer.RequestBuilder#load(Object)} is {@code null}.
   *
  ...
  /**
   * Overrides the {@link GifViewer.request.target.Target}'s width and height with the
   ...
   *
   * @param signature A unique non-null {@link GifViewer.load.Key} representing the current
   ...
   * {@link GifViewer.load.resource.bitmap.BitmapEncoder#COMPRESSION_FORMAT}.
   */
  ...
  /**
   * Sets the value for key
   * {@link GifViewer.load.resource.bitmap.BitmapEncoder#COMPRESSION_QUALITY}.
   */
  ...
  /**
   * Applies {@link GifViewer.load.resource.bitmap.CenterCrop} to all default types, and
   * ignores unknown types.
   *
   * <p>This will override previous calls to {@link #dontTransform()}.
   *
   * @param context Any {@link android.content.Context}.
   * @see #optionalTransform(Class, GifViewer.load.Transformation)
   ...
   *
   * @param context Any {@link android.content.Context}.
   * @see #transform(Class, GifViewer.load.Transformation)
  ...
  /**
   * Applies {@link GifViewer.load.resource.bitmap.FitCenter} to all default types, and
   * ignores unknown types.
   *
   * <p>This will override previous calls to {@link #dontTransform()}.
   *
  ...
  /**
   * Applies {@link GifViewer.load.resource.bitmap.CenterInside} to all default types, and
   * ignores unknown types.
   *
   * <p>This will override previous calls to {@link #dontTransform()}.
   *
  ...
  /**
   * Applies the given {@link GifViewer.load.Transformation} for
   ...
   * {@link GifViewer.load.resource.gif.GifDrawable})
   * and throws an exception if asked to transform an unknown type.
   *
   * <p>This will override previous calls to {@link #dontTransform()}.
   *
   * @param context        Any {@link android.content.Context}.
   * @param transformation Any {@link GifViewer.load.Transformation} for
   *                       {@link android.graphics.Bitmap}s.
   * @see #optionalTransform(android.content.Context, GifViewer.load.Transformation)
   * @see #optionalTransform(Class, GifViewer.load.Transformation)
   */
   ...
   * {@link android.graphics.Bitmap Bitmaps} to the default types ({@link android.graphics.Bitmap},
   * {@link android.graphics.drawable.BitmapDrawable}, and
   * {@link GifViewer.load.resource.gif.GifDrawable}) and ignores unknown types.
   *
   * <p>This will override previous calls to {@link #dontTransform()}.
   *
   * @param context        Any {@link android.content.Context}.
   * @param transformation Any {@link GifViewer.load.Transformation} for
   *                       {@link android.graphics.Bitmap}s.
   * @see #transform(android.content.Context, GifViewer.load.Transformation)
   * @see #transform(Class, GifViewer.load.Transformation)
   */
  ...
  /**
   * Applies the given {@link GifViewer.load.Transformation} for any decoded resource of
   ...
   * {@link GifViewer.load.Transformation} for a resource type that already has a
   * {@link GifViewer.load.Transformation} will override the previous call. </p>
   *
   ...
   * @param transformation The {@link GifViewer.load.Transformation} to apply.
   */
  ...
  /**
   * Removes all applied {@link GifViewer.load.Transformation Transformations} for all
   ...
   * {@link GifViewer.TransitionOptions#dontTransition()}</p>
   */
