...
/**
 * The standard concrete implementation of {@link GifViewer.request.BaseRequestOptions}.
 *
 * <p> Uses with custom types, transformations, or options can subclass and customize. {@link
 * GifViewer.request.BaseRequestOptions}. </p>
 */
...
public final class RequestOptions extends BaseRequestOptions<RequestOptions> {
  ...
  /**
   * Returns a {@link GifViewer.request.RequestOptions} with {@link
  ...
  /**
   * Returns a new {@link GifViewer.request.RequestOptions} with {@link #dontAnimate()}
   * called.
   */
