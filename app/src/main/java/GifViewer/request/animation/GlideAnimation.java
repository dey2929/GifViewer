package GifViewer.request.animation;
 ...
 * {@link GifViewer.request.target.Target}s in across resource types. Targets that wrap views will be able to
...
public interface GlideAnimation<R> {
     ...
     * ({@link GifViewer.request.animation.ViewAnimation},
     * {@link GifViewer.request.animation.ViewPropertyAnimation} and animated
     ...
     * @param adapter The {@link GifViewer.request.animation.GlideAnimation.ViewAdapter} wrapping a view that
     *                can at least return an {@link android.view.View} from
     *                {@link GifViewer.request.animation.GlideAnimation.ViewAdapter#getView()}.
