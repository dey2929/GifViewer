...
/**
 * A factory class that can produce different {@link GifViewer.request.animation.GlideAnimation}s based on the
...
public interface GlideAnimationFactory<R> {
    ...
    /**
     * Returns a new {@link GifViewer.request.animation.GlideAnimation}.
     *
