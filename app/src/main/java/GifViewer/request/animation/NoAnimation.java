...
/**
 * A simple {@link GifViewer.request.animation.GlideAnimation} that performs no actions.
 *
...
public class NoAnimation<R> implements GlideAnimation<R> {
    ...
    /**
     * A factory that always returns the same {@link GifViewer.request.animation.NoAnimation}.
     */
    ...
    /**
     * Returns an instance of a factory that produces {@link GifViewer.request.animation.NoAnimation}s.
     */
    @SuppressWarnings("unchecked")
    ...
    /**
     * Returns an instance of {@link GifViewer.request.animation.NoAnimation}.
     */
    @SuppressWarnings("unchecked")
