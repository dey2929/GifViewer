...
/**
 * A {@link GifViewer.request.animation.GlideAnimationFactory} that produces
 * {@link GifViewer.request.animation.ViewAnimation}s.
 *
...
public class ViewAnimationFactory<R> implements GlideAnimationFactory<R> {
    ...
    /**
     * Returns a new {@link GifViewer.request.animation.GlideAnimation} for the given arguments. If
     * isFromMemoryCache is {@code true} or isFirstImage is {@code false}, returns a
     * {@link GifViewer.request.animation.NoAnimation} and otherwise returns a new
