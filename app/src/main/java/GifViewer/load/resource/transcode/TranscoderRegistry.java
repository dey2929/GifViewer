...
/**
 * A class that allows {@link GifViewer.load.resource.transcode.ResourceTranscoder}s to be
...
public class TranscoderRegistry {
  ...
  /**
   * Registers the given {@link GifViewer.load.resource.transcode.ResourceTranscoder} using
   ...
   * {@link GifViewer.load.resource.transcode.ResourceTranscoder} for the given classes.
   *
