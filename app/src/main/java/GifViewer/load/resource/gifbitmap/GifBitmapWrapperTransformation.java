...
/**
 * A {@link GifViewer.load.Transformation} that can apply a wrapped {@link android.graphics.Bitmap}
 * transformation to both {@link android.graphics.Bitmap}s and {@link GifViewer.load.resource.gif.GifDrawable}.
 */
