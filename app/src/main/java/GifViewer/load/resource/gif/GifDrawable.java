...
public class GifDrawable extends Drawable implements GifFrameLoader.FrameCallback,
   ...
   * @param bitmapPool          A {@link GifViewer.load.engine.bitmap_recycle.BitmapPool}
   *                            that can be used to return the first frame when this drawable is
   *                            recycled.
   * @param frameTransformation An {@link GifViewer.load.Transformation} that can be
   ...
   * @see #setFrameTransformation(GifViewer.load.Transformation, Bitmap)
   */
