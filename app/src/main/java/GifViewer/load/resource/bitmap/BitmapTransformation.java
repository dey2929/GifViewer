...
/**
 * A simple {@link GifViewer.load.Transformation} for transforming
 * {@link Bitmap}s that abstracts away dealing with
 * {@link GifViewer.load.engine.Resource} objects for subclasses.
 *
 * Use cases will look something like this:
 * <pre>
 * <code>
 * public class FillSpace extends BaseBitmapTransformation {
 *     private static final String ID = "GifViewer.transformations.FillSpace";
...
public abstract class BitmapTransformation implements Transformation<Bitmap> {
   ...
   * {@link GifViewer.request.target.Target#SIZE_ORIGINAL},
   * this class converts them to be the size of the Bitmap we're going to transform before calling
   * this method.
   *
   * @param pool        A {@link GifViewer.load.engine.bitmap_recycle.BitmapPool} that can
