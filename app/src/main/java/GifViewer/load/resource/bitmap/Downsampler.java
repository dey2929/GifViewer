...
import GifViewer.load.resource.bitmap.DownsampleStrategy.SampleSizeRounding;
...
public final class Downsampler {
  ...
  /**
   * Indicates the {@link GifViewer.load.DecodeFormat} that will be used in conjunction
  ...
  public static final Option<DecodeFormat> DECODE_FORMAT = Option.memory(
      "GifViewer.load.resource.bitmap.Downsampler.DecodeFormat", DecodeFormat.DEFAULT);
  /**
   * Indicates the {@link GifViewer.load.resource.bitmap.DownsampleStrategy} option that
  ...
  public static final Option<DownsampleStrategy> DOWNSAMPLE_STRATEGY =
      Option.memory("GifViewer.load.resource.bitmap.Downsampler.DownsampleStrategy",
   ...
   * provided  {@link GifViewer.load.resource.bitmap.DownsampleStrategy} option.
   *
   ...
   * {@link GifViewer.load.engine.bitmap_recycle.BitmapPool} whose dimensions exactly match
