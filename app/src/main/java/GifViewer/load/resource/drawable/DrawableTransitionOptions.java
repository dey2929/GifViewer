package GifViewer.load.resource.drawable;

import android.graphics.drawable.Drawable;

import GifViewer.TransitionOptions;
import GifViewer.request.transition.DrawableCrossFadeFactory;
...
public final class DrawableTransitionOptions extends
   ...
   *     {@link GifViewer.request.transition.DrawableCrossFadeFactory.Builder(int)}
   */
   ...
   *     set, see {@link GifViewer.request.transition.DrawableCrossFadeFactory.Builder
