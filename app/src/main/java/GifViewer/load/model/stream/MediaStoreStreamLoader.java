...
import GifViewer.load.data.MediaStoreThumbFetcher;
import GifViewer.load.model.ModelLoader;

import java.io.InputStream;

/**
 * An {@link GifViewer.load.model.ModelLoader} that can use media store uris to open pre-generated thumbnails
 ...
 * it falls back to the wrapped {@link GifViewer.load.model.ModelLoader} to load the
