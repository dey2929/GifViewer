...
import GifViewer.load.engine.executor.Prioritized;
import GifViewer.request.ResourceCallback;

/**
 * A runnable class responsible for using an {@link GifViewer.load.engine.DecodeJob} to decode resources on a
 ...
 *     {@link GifViewer.load.engine.DecodeJob} to decode data directly from the original source.
 * </p>
 *
 * <p>
