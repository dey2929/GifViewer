package GifViewer.load.engine.bitmap_recycle;
...
/**
 * An {@link GifViewer.load.engine.bitmap_recycle.BitmapPool} implementation that uses an
 * {@link GifViewer.load.engine.bitmap_recycle.LruPoolStrategy} to bucket {@link Bitmap}s
