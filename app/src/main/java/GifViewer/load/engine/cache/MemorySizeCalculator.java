package GifViewer.load.engine.cache;
...
public final class MemorySizeCalculator {
  ...
  public static final class Builder {
     ...
     * {@link GifViewer.load.engine.cache.MemoryCache} should be able to hold and
    ...
    /**
     * Sets the number of device screens worth of pixels the
     * {@link GifViewer.load.engine.bitmap_recycle.BitmapPool} should be able to hold and
     * returns this Builder.
     */
     ...
     * taken up by Glide's {@link GifViewer.load.engine.cache.MemoryCache} and
     * {@link GifViewer.load.engine.bitmap_recycle.BitmapPool} put together, and returns
     * this builder.
     */
     ...
     * GifViewer.load.engine.bitmap_recycle.ArrayPool} to use to store temporary
