...
public abstract class DiskCacheStrategy {
   ...
   * {@link GifViewer.load.data.DataFetcher} and the
   * {@link GifViewer.load.EncodeStrategy} of the
   * {@link GifViewer.load.ResourceEncoder} (if an
   * {@link GifViewer.load.ResourceEncoder} is available).
   */
   ...
   * GifViewer.load.ResourceEncoder} will use to encode the resource.
   */
