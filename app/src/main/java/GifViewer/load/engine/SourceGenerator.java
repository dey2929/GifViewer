...
import GifViewer.load.model.ModelLoader.LoadData;
import GifViewer.util.LogTime;

import java.util.Collections;

/**
 * Generates {@link GifViewer.load.data.DataFetcher DataFetchers} from original source data
 * using registered {@link GifViewer.load.model.ModelLoader ModelLoaders} and the model
