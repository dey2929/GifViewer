package GifViewer.load.engine.executor;
...
public final class GlideExecutor extends ThreadPoolExecutor {
   ...
   * prefix, and the
   * {@link GifViewer.load.engine.executor.GlideExecutor.UncaughtThrowableStrategy#DEFAULT}
   ...
   * and {@link GifViewer.load.engine.executor.GlideExecutor.UncaughtThrowableStrategy}.
   *
   * <p>Disk cache executors do not allow network operations on their threads.
   *
   ...
   * GifViewer.load.engine.executor.GlideExecutor.UncaughtThrowableStrategy} to use to
