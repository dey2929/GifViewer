package GifViewer.load.engine.prefill;
 ...
 * {@link GifViewer.load.engine.bitmap_recycle.BitmapPool} with {@link Bitmap Bitmaps} of a
...
public final class PreFillType {
   ...
   * @param config The {@link Bitmap.Config} of the
   *               {@link Bitmap Bitmaps} to pre-fill.
   * @param weight An integer indicating how to balance pre-filling this size and configuration of
   *               {@link Bitmap} against any other sizes/configurations that may
   *               be being pre-filled.
   */
  ...
  /**
   * Returns the {@link Bitmap.Config} of the
   * {@link Bitmap Bitmaps}.
   */
