package GifViewer.module;

import android.content.Context;

import GifViewer.GlideBuilder;
import GifViewer.Registry;

/**
 * An interface allowing lazy configuration of Glide including setting options using
 * {@link GifViewer.GlideBuilder} and registering
 * {@link GifViewer.load.model.ModelLoader ModelLoaders}.
 *
 * <p> To use this interface: <ol> <li> Implement the GlideModule interface in a class with public
 * visibility, calling
 * {@link Registry#prepend(Class, Class, GifViewer.load.ResourceDecoder)} for each
 * {@link GifViewer.load.model.ModelLoader} you'd like to register:
 * <pre>
 *                  <code>
 ...
 * <pre>
 *                  {@code
 *                      -keepnames class * GifViewer.samples.flickr.FlickrGlideModule
 *                  }
 *              </pre>
 ...
 *                 {@code
 *                      <meta-data
 *                          android:name="GifViewer.samples.flickr.FlickrGlideModule"
...
public interface GlideModule {
  ...
  /**
   * Lazily apply options to a {@link GifViewer.GlideBuilder} immediately before the Glide
   * singleton is created.
   *
   * <p> This method will be called once and only once per implementation. </p>
   *
   * @param context An Application {@link android.content.Context}.
   * @param builder The {@link GifViewer.GlideBuilder} that will be used to create Glide.
   */
   ...
   *
   * @param context  An Application {@link android.content.Context}.
   * @param registry An {@link GifViewer.Registry} to use to register components.
   */
