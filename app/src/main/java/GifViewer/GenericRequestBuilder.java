...
import GifViewer.load.MultiTransformation;
...
import GifViewer.load.resource.UnitTransformation;
import GifViewer.load.resource.transcode.ResourceTranscoder;
import GifViewer.manager.Lifecycle;
import GifViewer.manager.RequestTracker;
import GifViewer.provider.ChildLoadProvider;
import GifViewer.provider.LoadProvider;
import GifViewer.request.FutureTarget;
import GifViewer.request.GenericRequest;
import GifViewer.request.Request;
import GifViewer.request.RequestCoordinator;
import GifViewer.request.RequestFutureTarget;
import GifViewer.request.RequestListener;
import GifViewer.request.ThumbnailRequestCoordinator;
import GifViewer.request.animation.GlideAnimationFactory;
import GifViewer.request.animation.NoAnimation;
import GifViewer.request.animation.ViewAnimationFactory;
import GifViewer.request.animation.ViewPropertyAnimation;
import GifViewer.request.animation.ViewPropertyAnimationFactory;
import GifViewer.request.target.PreloadTarget;
import GifViewer.request.target.Target;
import GifViewer.signature.EmptySignature;
 ...
 * @param <DataType> The data type that the resource {@link GifViewer.load.model.ModelLoader} will provide that
 *                  can be decoded by the {@link GifViewer.load.ResourceDecoder}.
...
public class GenericRequestBuilder<ModelType, DataType, ResourceType, TranscodeType> implements Cloneable {
     ...
     *     {@link GifViewer.load.model.ModelLoader}, {@link GifViewer.load.ResourceDecoder}, and
    ...
    /**
     * Sets the {@link GifViewer.load.ResourceDecoder} to use to load the resource from the original data.
     * By default, this decoder will only be used if the final transformed resource is not in the disk cache.
     *
     * @see #cacheDecoder(GifViewer.load.ResourceDecoder)
     * @see GifViewer.load.engine.DiskCacheStrategy
     *
     * @param decoder The {@link GifViewer.load.ResourceDecoder} to use to decode the resource.
     * @return This request builder.
     */
    ...
    /**
     * Sets the {@link GifViewer.load.ResourceDecoder} to use to load the resource from the disk cache. By
     * default, this decoder will only be used if the final transformed resource is already in the disk cache.
     *
     * @see #decoder(GifViewer.load.ResourceDecoder)
     * @see GifViewer.load.engine.DiskCacheStrategy
     *
    ...
    /**
     * Removes the current {@link GifViewer.load.Transformation}.
     *
     * @return This request builder.
     */
    ...
    /**
     * Sets the {@link GifViewer.load.resource.transcode.ResourceTranscoder} to use for this load.
     *
     * @see GifViewer.load.resource.transcode.UnitTranscoder
     * @see GifViewer.load.resource.transcode.GlideBitmapDrawableTranscoder
     * @see GifViewer.load.resource.transcode.GifBitmapWrapperDrawableTranscoder
     *
     ...
     *
     * @see #animate(int)
     * @see #animate(GifViewer.request.animation.ViewPropertyAnimation.Animator)
     *
     ...
     * {@link #animate(GifViewer.request.animation.ViewPropertyAnimation.Animator)}. Scheduled to be removed in
     * Glide 4.0.
     ...
     * memory cache).
     *
     * @param animator The {@link GifViewer.request.animation.ViewPropertyAnimation.Animator} to run.
     * @return This request builder.
     */
     ...
     * impractical to return that size from {@link Target#getSize(GifViewer.request.target.SizeReadyCallback)}.
     *
     ...
     * </p>
     *
     * @see GifViewer.signature.StringSignature
     *
     * @param signature A unique non-null {@link GifViewer.load.Key} representing the current state of the
     ...
     *
     * <p>
     *      This method must be called at least once before {@link #into(GifViewer.request.target.Target)} is
     *      called.
     * </p>
     *
     ...
     *
     * @see Glide#clear(GifViewer.request.target.Target)
     *
     ...
     * @return The {@link GifViewer.request.target.Target} used to wrap the given {@link ImageView}.
     */
     ...
     *
     * @see Glide#clear(GifViewer.request.FutureTarget)
     *
     * @return An {@link GifViewer.request.FutureTarget} that can be used to obtain the
