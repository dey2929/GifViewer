...
import GifViewer.request.transition.NoTransition;
import GifViewer.request.transition.TransitionFactory;
import GifViewer.request.transition.ViewAnimationFactory;
import GifViewer.request.transition.ViewPropertyAnimationFactory;
import GifViewer.request.transition.ViewPropertyTransition;
...
public abstract class TransitionOptions<CHILD extends TransitionOptions<CHILD, TranscodeType>,
   ...
   *
   * @param animator The {@link GifViewer.request.transition.ViewPropertyTransition
   *                 .Animator} to run.
   * @return This request builder.
   */
