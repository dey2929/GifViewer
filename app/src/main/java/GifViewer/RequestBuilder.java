...
import static GifViewer.request.RequestOptions.signatureOf;
...
import GifViewer.request.BaseRequestOptions;
...
import GifViewer.request.SingleRequest;
...
import GifViewer.signature.ApplicationVersionSignature;
 ...
 * {@link GifViewer.request.target.Target}.
 */
public class RequestBuilder<TranscodeType> implements Cloneable {
   ...
   * GifViewer.load.model.ModelLoader}, {@link GifViewer.load.ResourceDecoder},
   * and {@link GifViewer.load.Transformation}s. However,
   * {@link GifViewer.request.BaseRequestOptions#placeholder(int)} and
   * {@link GifViewer.request.BaseRequestOptions#error(int)}, and
   ...
   * {@link #into(GifViewer.request.target.Target)} is called. </p>
   *
   ...
   * {@link GifViewer.request.BaseRequestOptions#signature(GifViewer.load.Key)} to
   ...
   * {@link GifViewer.load.engine.DiskCacheStrategy#NONE} and/or
   * {@link GifViewer.request.BaseRequestOptions#skipMemoryCache(boolean)} may be
   * appropriate.
   * </p>
   *
   * @see #load(Object)
   ...
   * {@link GifViewer.load.model.UriLoader}.
   */
   ...
   * {@link GifViewer.request.BaseRequestOptions#signature(GifViewer.load.Key)}
   ...
   * the {@link GifViewer.load.model.ModelLoaderFactory} currently registered or
   * {@link Integer} to load the image represented by the given {@link Integer} resource id.
   * Defaults to {@link GifViewer.load.model.ResourceLoader} to load resource id models.
   *
   ...
   * using {@link GifViewer.load.engine.DiskCacheStrategy#NONE} via
   * {@link BaseRequestOptions#diskCacheStrategy(GifViewer.load.engine.DiskCacheStrategy)}
   * during development, and re-enabling the default
   * {@link GifViewer.load.engine.DiskCacheStrategy#RESOURCE} for release builds. </p>
   *
   * @see #load(Integer)
   ...
   * @return The
   * {@link GifViewer.request.target.Target} used to wrap the given {@link ImageView}.
   */
