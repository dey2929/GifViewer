 ...
 * GifViewer.RequestManager} that can be used to start, stop and manage Glide requests
 * started for targets the fragment or activity this fragment is a child of.
 *
 * @see GifViewer.manager.SupportRequestManagerFragment
 * @see GifViewer.manager.RequestManagerRetriever
 * @see GifViewer.RequestManager
 */
...
public class RequestManagerFragment extends Fragment {
  ...
  /**
   * Sets the current {@link GifViewer.RequestManager}.
   *
  ...
  /**
   * Returns the current {@link GifViewer.RequestManager} or null if none exists.
   */
  @Nullable
