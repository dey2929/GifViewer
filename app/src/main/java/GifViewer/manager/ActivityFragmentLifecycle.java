...
/**
 * A {@link GifViewer.manager.Lifecycle} implementation for tracking and notifying
...
class ActivityFragmentLifecycle implements Lifecycle {
   ...
   *
   * <p> Note - {@link GifViewer.manager.LifecycleListener}s that are added more than once
