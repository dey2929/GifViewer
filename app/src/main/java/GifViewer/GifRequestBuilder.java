...
public class GifRequestBuilder<ModelType>
    ...
    /**
     * Transforms each frame of the GIF using {@link GifViewer.load.resource.bitmap.CenterCrop}.
     *
     * @see #fitCenter()
     * @see #transformFrame(GifViewer.load.resource.bitmap.BitmapTransformation...)
     * @see #transformFrame(GifViewer.load.Transformation[])
    ...
    /**
     * Transforms each frame of the GIF using {@link GifViewer.load.resource.bitmap.FitCenter}.
     *
     * @see #centerCrop()
     * @see #transformFrame(GifViewer.load.resource.bitmap.BitmapTransformation...)
     * @see #transformFrame(GifViewer.load.Transformation[])
