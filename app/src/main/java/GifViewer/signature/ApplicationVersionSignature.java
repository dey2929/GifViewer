...
/**
 * A utility class for obtaining a {@link GifViewer.load.Key} signature containing the
...
public final class ApplicationVersionSignature {
  ...
  /**
   * Returns the signature {@link GifViewer.load.Key} for version code of the Application
