...
import GifViewer.load.resource.bitmap.FileDescriptorBitmapDecoder;
import GifViewer.load.resource.bitmap.ImageVideoBitmapDecoder;
...
public class BitmapRequestBuilder<ModelType, TranscodeType>
     ...
     * {@link GifViewer.load.resource.bitmap.Downsampler#AT_MOST}.
     *
     * @see #downsample(GifViewer.load.resource.bitmap.Downsampler)
     *
     * @return This request builder.
     */
    ...
    /**
     * Sets the {@link GifViewer.load.ResourceDecoder} that will be used to decode {@link Bitmap}s obtained
     ...
     * {@link #cacheDecoder(GifViewer.load.ResourceDecoder)}} with default decoders with the appropriate
     * options set.
     *
     * <p>
    ...
    /**
     * Transform images using the given {@link GifViewer.load.resource.bitmap.BitmapTransformation}s.
     *
     * @see #centerCrop()
     * @see #fitCenter()
     * @see #transform(GifViewer.load.Transformation[])
     *
    ...
    /**
     * Transform images using {@link GifViewer.load.resource.bitmap.CenterCrop}.
     *
     * @see #fitCenter()
     * @see #transform(GifViewer.load.resource.bitmap.BitmapTransformation...)
     * @see #transform(GifViewer.load.Transformation[])
     *
     * @return This request builder.
     */
    ...
    /**
     * Transform images using {@link GifViewer.load.resource.bitmap.FitCenter}.
     *
     * @see #centerCrop()
     * @see #transform(GifViewer.load.resource.bitmap.BitmapTransformation...)
     * @see #transform(GifViewer.load.Transformation[])
