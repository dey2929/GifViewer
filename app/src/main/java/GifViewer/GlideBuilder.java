...
import GifViewer.load.engine.bitmap_recycle.BitmapPoolAdapter;
import GifViewer.load.engine.bitmap_recycle.LruArrayPool;
import GifViewer.load.engine.bitmap_recycle.LruBitmapPool;
import GifViewer.load.engine.cache.DiskCache;
import GifViewer.load.engine.cache.InternalCacheDiskCacheFactory;
import GifViewer.load.engine.cache.LruResourceCache;
import GifViewer.load.engine.cache.MemoryCache;
import GifViewer.load.engine.cache.MemorySizeCalculator;
import GifViewer.load.engine.executor.GlideExecutor;
import GifViewer.manager.ConnectivityMonitorFactory;
import GifViewer.manager.DefaultConnectivityMonitorFactory;
...
public final class GlideBuilder {
  ...
  /**
   * Sets the {@link GifViewer.load.engine.bitmap_recycle.BitmapPool} implementation to use
  ...
  /**
   * Sets the {@link GifViewer.load.engine.cache.MemoryCache} implementation to store
   * {@link GifViewer.load.engine.Resource}s that are not currently in use.
   *
  ...
  /**
   * Sets the {@link GifViewer.load.engine.cache.DiskCache} implementation to use to store
   * {@link GifViewer.load.engine.Resource} data and thumbnails.
   *
   ...
   * use {@link #setDiskCache(GifViewer.load.engine.cache.DiskCache.Factory)} instead.
  ...
  /**
   * Sets the {@link GifViewer.load.engine.cache.DiskCache.Factory} implementation to use
   * to construct the {@link GifViewer.load.engine.cache.DiskCache} to use to store {@link
   * GifViewer.load.engine.Resource} data on disk.
   *
   ...
   * {@link GifViewer.load.engine.Resource}s that are not already in the cache.
   *
   * <p> Any implementation must order requests based on their {@link GifViewer.Priority}
  ...
  /**
   * Sets the {@link java.util.concurrent.ExecutorService} implementation to use when retrieving
   * {@link GifViewer.load.engine.Resource}s that are currently in cache.
   *
   * <p> Any implementation must order requests based on their {@link GifViewer.Priority}
   * for thumbnail requests to work properly.
   *
   ...
   * RequestBuilder#apply(GifViewer.request.BaseRequestOptions)} will override defaults
   * set here.
   *
  ...
  /**
   * Sets the {@link GifViewer.load.DecodeFormat} that will be the default format for all
   ...
   * GifViewer.load.DecodeFormat} for more details. </p>
   *
  ...
  /**
   * Sets the {@link GifViewer.manager.ConnectivityMonitorFactory}
   * to use to notify {@link GifViewer.RequestManager} of connectivity events.
   * If not set {@link GifViewer.manager.DefaultConnectivityMonitorFactory} would be used.
   *
